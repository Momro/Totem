...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_SYMBOLS] = LAYOUT(
		             RALT(KC_RBRACKET), RALT(KC_8), RALT(KC_7), LSFT(KC_8),   TD(9),   LSFT(KC_NONUS_BSLASH), LSFT(KC_9), RALT(KC_0), RALT(KC_9),   KC_GRAVE,
		             TD(0),         TD(1),       TD(27),        TD(4),        LSFT(KC_0), KC_NONUS_HASH, RALT(KC_Q), TD(6), LSFT(KC_RBRACKET), RALT(KC_NONUS_BSLASH)
		KC_TRNS, OSM(MOD_LCTL), TD(2), KC_RBRACKET, TD(3), LSFT(KC_GRAVE), TD(7), TD(8), LSFT(KC_5), LSFT(KC_6), OSM(MOD_LALT), KC_TRNS,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
    ),
	[_NUMBERS] = LAYOUT(
        TD(22), TD(31), TD(30), TD(29), KC_9, KC_8, TD(26), TD(25), TD(24), KC_6,
        OSM(MOD_LALT), TD(28), KC_RBRACKET, TD(27), KC_F11, KC_F12, TD(23), LSFT(KC_7), LSFT(KC_0), OSM(MOD_LSFT), 
    ...
    [_MOVEMENT] = LAYOUT(
       ...
       KC_NO, OSM(MOD_LCTL), KC_WH_U, KC_BTN2, KC_WH_D, KC_TRNS, LCTL(KC_V), KC_BSPC, KC_DELETE, KC_PGDOWN, OSM(MOD_LCTL), KC_TRNS,
